...
This project is by Atiyah B. Ellerbee for Eleven Fifty's Red Badge PERN project. The client portion's github repo is [here](https://github.com/spaclyn/prServer).
